...
**Live → https://baditaflorin.github.io/mesh-skill-swap/**

**Source → https://github.com/baditaflorin/mesh-skill-swap**
...
git clone https://github.com/baditaflorin/mesh-skill-swap
cd mesh-skill-swap
npm install
npm run dev
```
...
- `mesh-skill-swap:signalingUrl`
- `mesh-skill-swap:turnTokenUrl`
- `mesh-skill-swap:iceServers`
- `mesh-skill-swap:room`
